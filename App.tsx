        ...
        <div className="relative" ref={downloadMenuRef}>
          ...
          {showDownloadMenu && (
            <div className="absolute right-0 mt-2 w-48 rounded-xl liquid-glass border border-white/10 shadow-2xl overflow-hidden z-50 animate-slide-up">
              <a href="https://github.com/xDustzz/xDustAI/releases/download/v2.6.1/xDustAI.apk" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 hover:bg-white/10 transition-colors text-sm text-white/90 hover:text-white border-b border-white/5">
                <Download size={16} />
                Download .apk
              </a>
              <a href="https://github.com/xDustzz/xDustAI/releases/download/v2.6.1/xDustAI.exe" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 hover:bg-white/10 transition-colors text-sm text-white/90 hover:text-white">
                <Download size={16} />
                Download .exe
              </a>
            </div>
                       ...
                       <div className="flex flex-col gap-5">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="liquid-glass p-4 rounded-2xl flex items-center justify-between group hover:bg-white/10 transition-all duration-300 hover:scale-[1.02] border border-white/5 hover:border-white/20 hover:shadow-lg">
                                    ...
                                    <span className="text-sm font-bold bg-white/10 px-2 py-0.5 rounded text-white/80 font-mono border border-white/5">v2.5.0</span>
                                </div>
                            </div>
                       </div>
                   )}
